...
namespace DapperExtensions
{
    public static class DapperExtensions
    {
        ...
        public static IEnumerable<T> GetPage<T>(this IDbConnection connection, object predicate, int page, int resultsPerPage, IDbTransaction transaction = null, int? commandTimeout = null, bool buffered = false) where T : class
        {
            return Instance.GetPage<T>(connection, predicate, page, resultsPerPage, transaction, commandTimeout, buffered);
        }
        ...
        public static T GetByPredicates<T>(this IDbConnection connection, object predicate, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            return Instance.GetByPredicates<T>(connection, predicate, transaction, commandTimeout);
        }
    }
}
